...
import static com.jaewoo.fp.combinatorpattern.CustomerRegistrationValidator.ValidationResult.*;
...
public interface CustomerRegistrationValidator extends Function<Customer, ValidationResult> {
    ...
    default CustomerRegistrationValidator and (CustomerRegistrationValidator other){
        return customer -> {
            CustomerRegistrationValidator.ValidationResult result = this.apply(customer);
